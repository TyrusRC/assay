...
var VulnerabilityMapping = map[string]string{
	...
	"Weak Encryption":         "A04:2025",
	"Sensitive Data Exposure": "A04:2025",
	"Missing Encryption":      "A04:2025",
	"Weak TLS":                "A04:2025",
	"Clear Text Transmission": "A04:2025",

	// A03:2025 - Injection
	"Injection":                      "A05:2025",
	"SQL Injection":                  "A05:2025",
	"XSS":                            "A05:2025",
	"Cross-Site Scripting":           "A05:2025",
	"Command Injection":              "A05:2025",
	"LDAP Injection":                 "A05:2025",
	"XPath Injection":                "A05:2025",
	"NoSQL Injection":                "A05:2025",
	"SSTI":                           "A05:2025",
	"Server-Side Template Injection": "A05:2025",
	"Header Injection":               "A05:2025",

	// A04:2025 - Insecure Design
	"Insecure Design":       "A06:2025",
	"Business Logic Flaw":   "A06:2025",
	"Missing Rate Limiting": "A06:2025",

	// A05:2025 - Security Misconfiguration
	"Security Misconfiguration": "A02:2025",
	"XXE":                       "A02:2025",
	"XML External Entity":       "A02:2025",
	"Default Credentials":       "A02:2025",
	"Verbose Error Messages":    "A02:2025",
	"Missing Security Headers":  "A02:2025",
	"Open Cloud Storage":        "A02:2025",

	// A06:2025 - Vulnerable Components
	"Vulnerable Components": "A03:2025",
	"Outdated Software":     "A03:2025",
	"Unpatched Software":    "A03:2025",
	"Known Vulnerability":   "A03:2025",
	...
	"SSRF":                        "A01:2025",
	"Server-Side Request Forgery": "A01:2025",
}
...
var categories = map[string]Category{
	...
	"A03:2025": {
		...
		Description: "Risks arising from third-party software components and dependencies, including outdated libraries, registry confusion, and tampered build artefacts. Encompasses the 2021-era 'Vulnerable and Outdated Components' category and adds supply chain provenance concerns.",
		CWEs:        []string{"CWE-1035", "CWE-1104", "CWE-494", "CWE-829"},
		Remediation: "Remove unused dependencies. Continuously inventory client-side and server-side components. Monitor for vulnerabilities. Only obtain components from official sources with signature verification. Enforce package-source allowlists. Use SBOM and software composition analysis.",
	},
	"A07:2025": {
		ID:          "A07:2025",
		Version:     "2025",
	...
	"A10:2025": {
		...
		Description: "Failure to handle exceptional conditions safely — uncaught exceptions that leak stack traces, incomplete error recovery that leaves state corrupted, or fallback paths that bypass security controls when normal flow fails.",
		CWEs:        []string{"CWE-209", "CWE-388", "CWE-440", "CWE-754", "CWE-755", "CWE-756"},
		Remediation: "Catch and handle all exceptions explicitly. Never expose raw stack traces to users. Ensure error paths preserve security invariants (auth checks, audit logging). Test exceptional conditions, not just happy paths. Use defensive programming to validate post-conditions.",
	},
}
...
var risks = map[string]Risk{
	...
	"A10:2025": {
		...
		MaxCVSS:       9.8,
		CommonCWEs: []CWE{
			{ID: "CWE-209", Name: "Information Exposure Through Error Message", Description: "The application generates an error message that includes sensitive information about its environment or related state."},
			{ID: "CWE-388", Name: "7PK - Errors", Description: "Improper handling of errors that occur during processing."},
			{ID: "CWE-754", Name: "Improper Check for Unusual or Exceptional Conditions", Description: "The software does not check or improperly checks for unusual or exceptional conditions that may negatively impact normal flow."},
		},
	},
}
